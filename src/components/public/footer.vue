...
.footer_Nav{padding-top: 4%;padding-bottom: 3%; width: 90%;margin: 0 auto;display: flex;justify-content: space-around;text-align: left;
    .footer_NavList{
